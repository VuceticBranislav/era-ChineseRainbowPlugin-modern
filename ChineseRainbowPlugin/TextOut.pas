...
uses
  ...
  procedure DoMyTextOut_New (str:myPChar; Surface, x, y, BoxWidth, BoxHeight, ColorA, Mode, hfont, unknow:integer); stdcall;
  procedure DoMyDialog (hfont, MaxWidth: integer; s: myPChar); stdcall;
...
procedure GetQWCode(HZ:myPChar;var Q,W:word);stdcall;
begin
  Q := byte(HZ[0]) - 160;
...
procedure MakeChar12 (StartY, StartX, Surface: integer; HZ: myPChar; Color: integer); stdcall;
var
  OffSet:integer;
...
procedure MakeChar10 (StartY, StartX, Surface: integer; HZ: myPChar; Color: integer); stdcall;
var
  OffSet:integer;
...
procedure MakeChar24(StartY, StartX, Surface: integer; HZ: myPChar; Color: integer); stdcall;
var
  OffSet:integer;
...
function GetEngCharWidth (Assic:byte;hfont:LongWord):integer;stdcall;
var
  temp:integer;
begin
...
function GetStrRowCount(str:myPChar;hfont,RowWidth:integer):integer;stdcall;
var
...
procedure DrawLineToPcx16 (str: myPChar; StrLen, ColorA, hfont, y, x: integer; Surface: integer); stdcall;
const
  DEF_COLOR = 0;
